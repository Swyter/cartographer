...
# Tuavus   Pamir   vezona 
  ...
  ("training_ground_2", "Training Field",  icon_training_ground|pf_hide_defenders|pf_is_static|pf_always_visible|pf_label_medium, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-13.77, 32.04),[], 274), #[swycartographr] prev. coords: (-13.19, 32.59) rot: 100 #[swycartographr] prev. coords: (-13, 32.79) rot: 169 #[swycartographr] prev. coords: (-13, 32.79) rot: 10 #[swycartographr] prev. coords: (-12.8, 33) rot: 202.5 #[swycartographr] prev. coords: (-13, 32.79) rot: 0 #[swycartographr] prev. coords: (-13, 32.79) rot: 115 #[swycartographr] prev. coords: (-13.19, 32.59) rot: 0 #[swycartographr] prev. coords: (-13.38, 32.39) rot: 0 #[swycartographr] prev. coords: (-13.22, 32.61) rot: 0 #[swycartographr] prev. coords: (-13.56, 32.2) rot: 256 #[swycartographr] prev. coords: (-13.22, 32.61) rot: 203 #[swycartographr] prev. coords: (-13.39, 32.37) rot: 291 #[swycartographr] prev. coords: (-13.39, 32.37) rot: 3 #[swycartographr] prev. coords: (-13.22, 32.61) rot: 226 #[swycartographr] prev. coords: (-13.4, 32.42) rot: 331 #[swycartographr] prev. coords: (-13.59, 32.23) rot: 51
...
#  bridge_a
  ...
  ("Bridge_6","{!}6",icon_bridge_b|pf_is_static|pf_always_visible|pf_no_label, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-8.96, 52.01),[], 201), #[swycartographr] prev. coords: (-8.84, 52.23) rot: -73.5 #[swycartographr] prev. coords: (-8.83, 52.24) rot: 0 #[swycartographr] prev. coords: (4.59, 39.67) rot: 17 #[swycartographr] prev. coords: (-8.9, 52.12)
